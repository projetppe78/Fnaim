       ...
       <tr>
        ...
        <tr>
            <td><strong>Telephone :</strong></td>
             <td><input type=\"tel\" value='" . $_SESSION["telephone"] . "' name='phone'></td>
       </tr>
       <tr>
            <td><strong>Départment :</strong></td>
            <td><input type=\"text\" value='" . $_SESSION["departement"] . "' name='departement'></td>
       </tr>
       <tr>
            ...
            <label  style='padding-top: 2%; color: red' for=\"passs\"><strong>Confirmer avec votre PASSWORD ou changer le !</strong></label></td>            
                ...
                <div style='padding-top: 3%'>
                     <center>
                        ...
                        <input  style='background-color: dodgerblue; ' class=\"btn \" type='submit' value = 'Enregistrer les modification' name ='enregModif'>
                     </center>
                </div>
            </form>
        </div>
